      ...
      <div className="right flex items-start flex-col justify-start flex-1 h-[100%] pt-[9rem]">
        ...
        <div className="detail flex flex-col mt-5 text-4xl">
          ...
          <span className="text-sm mt-3 text-[#4D586A]">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit voluptas animi quidem,   <br />
            laudantium asperiores commodi, tempore ipsum veritatis repudiandae dolores ab, <br /> officia quia ullam eum doloribus numquam esse neque. Tempora!
          </span>
        </div>
        {/* Music Player */}
